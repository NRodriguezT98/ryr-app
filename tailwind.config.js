  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'ring': { '0%, 100%': { transform: 'rotate(0)' }, '10%, 50%, 90%': { transform: 'rotate(-15deg)' }, '30%, 70%': { transform: 'rotate(15deg)' } },
        'pulse-once': { '0%, 100%': { transform: 'scale(1)', opacity: '1' }, '50%': { transform: 'scale(1.02)', opacity: '0.9' } }
      },
      animation: {
