...
const FinancialSummary = ({ vivienda, resumen }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Card 1: Valor Total */}
            <div className="group relative stagger-animation">
            ...
            <div className="group relative stagger-animation" style={{ animationDelay: '100ms' }}>
                ...
                <div className="relative bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-emerald-200 dark:border-emerald-900 shadow-sm hover:shadow-md transition-all">
                    ...
                    <div className="pt-3 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div
                                className={`h-full rounded-full transition-all duration-800 ${porcentajeCubierto >= 100
                                    ? 'bg-gradient-to-r from-emerald-500 to-teal-600'
                                    : 'bg-gradient-to-r from-amber-500 to-orange-600'
                                    }`}
                                style={{ width: `${Math.min(porcentajeCubierto, 100)}%` }}
                            />
                        </div>
                    </div>
                </div>
            ...
            {/* Card 3: Balance */}
            <div className="group relative stagger-animation" style={{ animationDelay: '200ms' }}>
