/**
 * @file DashboardPage.OPTIMIZED.jsx
 * @description Dashboard optimizado con carga lazy de datos
 * Mejora: Carga inicial solo estadísticas básicas, datos completos bajo demanda
 */
...
const DashboardPage = () => {
    // Carga lazy de todas las colecciones necesarias para el dashboard
    ...
    // Mostrar loader mientras cargan las colecciones
    if (!isReady) {
