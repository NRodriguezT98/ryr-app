                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block font-semibold mb-1 flex items-center" htmlFor="matricula">
                                ...
                                <HelpTooltip id="matricula" content="Número único de identificación del inmueble ante la Oficina de Registro. Usualmente contiene números y guiones." />
                            </label>
                        ...
                        <div>
                            <label className="block font-semibold mb-1 flex items-center" htmlFor="nomenclatura">
                                ...
                                <HelpTooltip id="nomenclatura" content="Dirección oficial y completa de la vivienda, tal como aparecerá en los documentos legales y de servicios públicos." />
                            </label>
