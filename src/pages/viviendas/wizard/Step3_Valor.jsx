                ...
                <div>
                    ...
                    {formData.esEsquinera && (
                        <div className="mt-4 pl-8 animate-fade-in">
                            ...
                            <select id="recargoEsquinera" name="recargoEsquinera" value={formData.recargoEsquinera} onChange={handleInputChange} className="w-full border p-3 rounded-lg border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
