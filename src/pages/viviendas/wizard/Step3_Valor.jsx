            ...
            <div className="space-y-6">
                <div>
                    ...
                    <NumericFormat
                        ...
                        onValueChange={(values) => handleValueChange('valorBase', values.value)}
                        thousandSeparator="."
                        decimalSeparator=","
                        prefix="$ "
                        className={`w-full border p-3 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white ${errors.valorBase ? "border-red-500" : "border-gray-300"} disabled:bg-gray-200 dark:disabled:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-70`}
                ...
                <div>
                    <label className="flex items-center space-x-3 cursor-pointer">
                        <input
                            type="checkbox"
                            name="esEsquinera"
                            checked={formData.esEsquinera}
                            onChange={handleCheckboxChange}
                            className="h-5 w-5 rounded text-red-600 focus:ring-red-500 disabled:cursor-not-allowed disabled:opacity-50"
                            disabled={isFinancialLocked}
                        />
                    ...
                    {formData.esEsquinera && (
                        <div className="mt-4 pl-8 animate-fade-in">
                            ...
                            <select
                                id="recargoEsquinera"
                                name="recargoEsquinera"
                                value={formData.recargoEsquinera}
                                onChange={handleInputChange}
                                className="w-full border p-3 rounded-lg border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white disabled:bg-gray-200 dark:disabled:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-70"
                                disabled={isFinancialLocked}
                            >
