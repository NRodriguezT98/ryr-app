...
const AbonoCard = ({ abono, onEdit, onDelete, isReadOnly = false }) => {
    ...
    return (
        <div className={`bg-white rounded-xl shadow-md border ${cardBorder} p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all`}>
