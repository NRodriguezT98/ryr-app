export const validateAbono = (formData, resumenPago) => {
    ...
    if (!formData.fechaPago) {
        ...
        // Creamos la fecha seleccionada a medianoche para evitar problemas de zona horaria
        const fechaSeleccionada = new Date(formData.fechaPago + 'T00:00:00');
        const hoy = new Date();
        hoy.setHours(0, 0, 0, 0); // Reseteamos la hora de hoy a medianoche para una comparación justa
