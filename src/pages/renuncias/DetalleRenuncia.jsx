...
import { ArrowLeft, User, Home, Calendar, DollarSign, CheckCircle, Download } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
                ...
                {renuncia.estadoDevolucion === 'Pagada' && (
                    <div className="mt-8 pt-6 border-t dark:border-gray-700">
                        <h3 className="font-bold text-xl mb-4 flex items-center gap-2 text-green-700 dark:text-green-400"><CheckCircle /> Devolución Completada</h3>
                ...
                <div className="mt-8 pt-6 border-t dark:border-gray-700">
                    <h3 className="font-bold text-xl mb-4 flex items-center gap-2 dark:text-gray-100"><DollarSign /> Desglose de Devolución</h3>
                    ...
                    <h4 className="font-semibold mb-4 dark:text-gray-200">Abonos Registrados para este Proceso:</h4>
