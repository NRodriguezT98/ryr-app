// src/pages/admin/audit-details/ArchiveViviendaDetails.jsx

import React from 'react';
import { Home, MapPin, Clock, Archive } from 'lucide-react';
...
const ArchiveViviendaDetails = ({ log }) => {
    ...
    return (
        <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg space-y-3">
            <h4 className="font-semibold text-gray-600 dark:text-gray-300 flex items-center gap-2 mb-2">
                <Archive size={16} /> Detalles del Archivado
            </h4>
...
export default ArchiveViviendaDetails;