            ...
            filterControls={
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 w-full">
                    <div className="flex-shrink-0 bg-gray-100 dark:bg-gray-700/50 p-1 rounded-lg">
                        ...
                        <button onClick={() => setStatusFilter('enProcesoDeRenuncia')} className={`px-4 py-1.5 text-sm font-semibold rounded-md transition-colors ${statusFilter === 'enProcesoDeRenuncia' ? 'bg-white dark:bg-gray-900 shadow text-orange-600' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600/50'}`}>En Renuncia</button>
